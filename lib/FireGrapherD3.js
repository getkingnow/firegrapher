...
FireGrapher.prototype.addDataPointToBarGraph = function(newDataPoint) {
  ...
  redrawScales = redrawScales || this.changeScales(
...
FireGrapher.prototype.drawScales = function() {
  ...
  this.graph.selectAll(".domain")
    .attr("stroke", this.config.graph.outerStrokeColor)
    .attr("stroke-width", this.config.graph.outerStrokeWidth)
    .attr("fill", this.config.graph.fillColor)
    .attr("fill-opacity", this.config.graph.fillOpacity);

  this.graph.selectAll(".xAxis line, .yAxis line")
    .attr("stroke", this.config.graph.innerStrokeColor)
    .attr("stroke-width", this.config.graph.innerStrokeWidth);

  this.graph.selectAll(".xAxis text")
    .attr("stroke", "none")
    .attr("fill", this.config.graph.axes.x.ticks.fillColor)
    .attr("font-size", this.config.graph.axes.x.ticks.fontSize)

  this.graph.selectAll(".yAxis text")
    .attr("stroke", "none")
    .attr("fill", this.config.graph.axes.y.ticks.fillColor)
    .attr("font-size", this.config.graph.axes.y.ticks.fontSize)
  ...
  this.graph
    .append("text")
      ...
      .attr("fill", this.config.graph.axes.x.label.fillColor)
      .attr("font-size", this.config.graph.axes.x.label.fontSize)
  ...
  this.graph
    .append("text")
      ...
      .attr("fill", this.config.graph.axes.y.label.fillColor)
      .attr("font-size", this.config.graph.axes.y.label.fontSize)
      .attr("font-weight", "bold")
