var FireGrapher = (function() {
  ...
  FireGrapher.prototype.addToD3 = function(newDataPoint) {
    ...
    if (typeof line === "undefined") {
      console.log("NEW LINE: " + newDataPoint.line);
      line = d3.svg.line()
      ...
      this.graph.append("svg:" + newDataPoint.line).attr("d", line(this.graphData[newDataPoint.line]));

      this.graphLines[newDataPoint.line] = line;
    }
    else {
      console.log("UPDATE: " + newDataPoint.line);
      // update the line with the data
      this.graph.selectAll(newDataPoint.line)
